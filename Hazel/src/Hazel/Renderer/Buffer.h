...
namespace Hazel {
	...
	static uint32_t ShaderDataTypeSize(ShaderDataType type) {
		...
		switch (type) {
			...
			case Hazel::ShaderDataType::Mat3:	return 36;
			case Hazel::ShaderDataType::Mat4:	return 64;
			case Hazel::ShaderDataType::Int:	return  4;
			case Hazel::ShaderDataType::Int2:	return  8;
			case Hazel::ShaderDataType::Int3:	return 12;
			case Hazel::ShaderDataType::Int4:	return 16;
			case Hazel::ShaderDataType::Bool:	return  1;
		}

		HZ_CORE_ASSERT(false, "ShaderDataTypeSize::Unknown ShaderDataType!");
		return 0;
	}
	...
	struct BufferElement {
		...
		uint32_t GetComponentCount() const {
			...
			switch (Type) {
				...
				case Hazel::ShaderDataType::Mat3:	return  9;
				case Hazel::ShaderDataType::Mat4:	return 16;
			...
			HZ_CORE_ASSERT(false, "GetComponentCount::Unknown ShaderDataType!");
			return 0;
		}
	};
	...
	class BufferLayout {
		...
		public:
			...
			BufferLayout(const std::initializer_list<BufferElement>& element)
				: m_Elements(element) { CalculateOffsetsAndStride(); }
